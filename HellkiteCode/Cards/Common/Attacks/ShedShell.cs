...
public sealed class Shedshell() : HellkiteCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    ...
    {
        DynamicVars.Damage.UpgradeValueBy(3M); DynamicVars[nameof(ScorchPower)].UpgradeValueBy(1M);
    }
}